...
public class ChatAllHistoryFragment extends Fragment {
	...
	private LinearLayout invitation_container;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		msg_tv=(TextView)getView().findViewById(R.id.fragment_message_chat_hostory);
		invitation_tv=(TextView)getView().findViewById(R.id.fragment_message_invitation);
		message_container=(LinearLayout)getView().findViewById(R.id.message_container);
		invitation_container=(LinearLayout)getView().findViewById(R.id.invitation_container);
		
		msg_tv.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				if(invitation_container.isShown())
				{
					invitation_container.setVisibility(View.GONE);					
				}
				if(!message_container.isShown())
				{
		...
		invitation_tv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if(!invitation_container.isShown())
				{
					invitation_container.setVisibility(View.VISIBLE);
				}
			}
		});
