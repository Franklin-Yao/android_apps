...
import com.michu.huanxin.domain.InviteMessage;
import com.michu.huanxin.domain.User;
import com.michu.huanxin.domain.InviteMessage.InviteMesageStatus;
...
public class MainActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fragments = new Fragment[] { serviceFragment,chatHistoryFragment, contactListFragment,findFragment,userFragment };
		// 添加显示第一个fragment
	...
	private void initView() {
		...
		mTabs = new Button[5];
		mTabs[0] = (Button) findViewById(R.id.btn_service);
...
//		Log.e("", "index:  "+index+"  "+currentTabIndex);
